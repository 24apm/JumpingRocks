...
if ($func == 'payments_status_update') {
  ...
  if ($item_info == "abc123") {
    ...
    $item['image_url'] = '../../asset/img/cat.png'; //'https://www.facebook.com/images/gifts/740.png';
    $item['product_url'] = '../../asset/img/cat.png'; //'https://www.facebook.com/images/gifts/740.png';
  }
